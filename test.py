...
class TaskPlanner:
    ...
    def create_widgets(self):
        ...
        self.task_entry_label = tk.Label(self.root, text="Введите название задачи:", bg="forest green", fg="white")
        self.task_entry_label.pack(pady=5)

        self.task_entry = tk.Entry(self.root, width=40, bg="firebrick2")  # Поле ввода задачи - firebrick2
        self.task_entry.pack(pady=5)

        # Поле для времени выполнения
        self.time_entry_label = tk.Label(self.root, text="Введите время выполнения:", bg="forest green", fg="white")
        self.time_entry_label.pack(pady=5)

        self.time_entry = tk.Entry(self.root, width=40, bg="firebrick2")  # Поле ввода времени - firebrick2
        self.time_entry.pack(pady=5)

        # Поле для ввода места выполнения
        self.location_entry_label = tk.Label(self.root, text="Введите место выполнения:", bg="forest green", fg="white")
        self.location_entry_label.pack(pady=5)

        self.location_entry = tk.Entry(self.root, width=40, bg="firebrick2")  # Поле ввода места - firebrick2
        ...
        # Список задач
        self.tasks_listbox = tk.Listbox(self.root, width=60, height=10, bg="gold2")  # Поле отображения задач - gold2
